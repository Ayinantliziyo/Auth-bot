...
client_auth = Client(api_key="", aid="", application_secret="")
...
def auth():
    ...
    if username and password != "":
        print("Login Information Found. Attempting To Login")
        login(username, password)
    else:
        print("[1] Login(EXE selfbot login)\n[2] Redeem Your Key\n[3] Reset HWID")
        print("Go to are portal for more information.")
        ...
        if auth_choice == "1":
            ...
            print("Please go to this link and log in with your Login")
            input("Press Enter to continue...")
        else:
